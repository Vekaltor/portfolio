...
export default function Contact() {
  ...
  const contactLinks: ContactLinkItem[] = [
    ...
    },
    {
      href: 'tel:883117883',
      label: '883 117 883',
      icon: <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.3h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 9a16 16 0 0 0 6 6l1.27-.91a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>,
    },
    {
      href: 'https://linkedin.com/',
      label: 'LinkedIn',
      icon: <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d={LI}/></svg>,
      external: true,
    },
    {
      href: 'https://github.com/',
      label: 'GitHub',
      icon: <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d={GH}/></svg>,
      external: true,
    },
    {
      href: '/CV_Kamil_Wojcik.pdf',
      label: t('contact.dl'),
      icon: <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>,
      download: true,
    },
  ]
        ...
        <div ref={rightRef} className="rvr d2">
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-[.42rem]">
              <label className="text-[.7rem] font-semibold text-[var(--text2)] tracking-[.05em]">{t('f.msg')}</label>
              <textarea
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-16 pb-12 mb-10"
          ...
          <div className="text-right">
            <div className="inline-flex items-center gap-2 text-[.74rem] font-semibold text-[var(--accent)] mb-2">
